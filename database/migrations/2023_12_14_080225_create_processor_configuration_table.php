...
class CreateProcessorConfigurationTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('processor_configuration', function (Blueprint $table) {
            $table->id('asset_id');
    ...
    {
        Schema::dropIfExists('processor_configuration');
    }
}
