...
<head>
    ...
    <link rel="apple-touch-icon"
        href="{{ $snipeSettings && $snipeSettings->favicon != '' ? Storage::disk('public')->url(e($snipeSettings->logo)) : config('app.url') . '/img/logo.png' }}">
...
<div class="wrapper">
                    ...
                    @can('view', \App\Models\Consumable::class)
                        ...
                        @can('view', \App\Models\Component::class)
                            <li{!! Request::is('components*') ? ' class="active"' : '' !!}>
                                ...
                                @can('NetworkDiscovery.view')
                                    <li class="treeview{{ Request::is('NetworkDiscovery*') ? ' active' : '' }}">
                                        <a href="#" class="dropdown-toggle">
                                            <i class="fa-solid fa-network-wired" style="margin-left: 3px;"></i>
                                            <span>{{ trans('Network Discovery') }}</span>
                                            <i class="fa fa-angle-left pull-right"></i>
                                        </a>

                                        <ul class="treeview-menu">
                                            <li>
                                                <a href="{{ route('AutoDiscovery.ipScan') }}"
                                                    {{ Request::is('AutoDiscovery/ipScan') ? ' class="active"' : '' }}>
                                                    {{ trans('IP Scan') }}
                                                </a>
                                            </li>
                                            <li>
                                                <a href="{{ route('AutoDiscovery.viewipScan') }}"
                                                    {{ Request::is('AutoDiscovery/viewipScan') ? ' class="active"' : '' }}>
                                                    {{ trans('View IP Scan') }}
                                                </a>
                                            </li>
                                            <li>
                                                <a href="{{ route('AutoDiscovery.subnetScan') }}"
                                                    {{ Request::is('AutoDiscovery/subnetScan') ? ' class="active"' : '' }}>
                                                    {{ trans('Subnet Scan') }}
                                                </a>
                                            </li>
                                            <li>
                                                <a href="{{ route('AutoDiscovery.viewsubnetscan') }}"
                                                    {{ Request::is('AutoDiscovery/viewsubnetScan') ? ' class="active"' : '' }}>
                                                    {{ trans('View Subnet Scan') }}
                                                </a>
                                            </li>
                                            <li>
                                                <a href="{{ route('AutoDiscovery.schedueleScan') }}"
                                                    {{ Request::is('AutoDiscovery/schedueleScan') ? ' class="active"' : '' }}>
                                                    {{ trans('Schedule Scan') }}
                                                </a>
                                            </li>
                                            <li>
                                                <a href="{{ route('AutoDiscovery.viewschedueleScan') }}"
                                                    {{ Request::is('AutoDiscovery/viewschedueleScan') ? ' class="active"' : '' }}>
                                                    {{ trans('View Schedule Scan') }}
                                                </a>
                                            </li>
                                            <li>
                                                <a href="{{ route('AutoDiscovery.viewNetworkDiscovery') }}"
                                                    {{ Request::is('AutoDiscovery/viewNetworkDiscovery') ? ' class="active"' : '' }}>
                                                    {{ trans('View Network Discovery') }}
                                                </a>
                                            </li>
                                            {{-- <li>
                                                <a href="{{ route('AutoDiscovery.viewSWInventory') }}"
                                                    {{ Request::is('AutoDiscovery/viewSWInventory') ? ' class="active"' : '' }}>
                                                    {{ trans('View Software Inventory') }}
                                                </a>
                                            </li>
                                            <li>
                                                <a href="{{ route('AutoDiscovery.viewSWLInventory') }}"
                                                    {{ Request::is('AutoDiscovery/viewSWLInventory') ? ' class="active"' : '' }}>
                                                    {{ trans('View Software License Inventory') }}
                                                </a>
                                            </li> --}}
                                        </ul>
                                    </li>
                                @endcan
                                @can('SoftwareInventory.view')
                                    <li class="treeview{{ Request::is('SoftwareInventory*') ? ' active' : '' }}">
                                        <a href="#" class="dropdown-toggle">
                                            <i class="fas fa-desktop" style="margin-left: 3px;"></i>
                                            <span>{{ trans('Software Inventory') }}</span>
                                        </a>
                                        <ul class="treeview-menu">
                                            <li>
                                                <a href="{{ route('AutoDiscovery.viewSWInventory') }}"
                                            ...
                                            <li>
                                                <a href="{{ route('AutoDiscovery.viewDeviceWise') }}"
                                                    {{ Request::is('AutoDiscovery/viewDeviceWise') ? ' class="active"' : '' }}>
                                                    {{ trans('View Device Wise') }}
                                                </a>
                                            </li>
                                            <li>
                                                <a href="{{ route('AutoDiscovery.viewSoftwareWise') }}"
                                                    {{ Request::is('AutoDiscovery/viewSoftwareWise') ? ' class="active"' : '' }}>
                                ...
                                @endcan
                                @can('HardwareInventory.view')
                                    <li class="treeview{{ Request::is('HardwareInventory*') ? ' active' : '' }}">
                                        <a href="#" class="dropdown-toggle">
                                            <i class="far fa-hdd" style="margin-left: 3px;"></i>
                                            <span>{{ trans('Hardware Inventory') }}</span>
                                        </a>
                                        <ul class="treeview-menu">
                                            <li>
                                                <a href="{{ route('AutoDiscovery.viewHWInventory') }}"
                                                    {{ Request::is('AutoDiscovery/viewHWInventory') ? ' class="active"' : '' }}>
                                            ...
                                            <li>
                                                <a href="{{ route('AutoDiscovery.viewMemoryConfiguration') }}"
                                                    ...
                                                    {{ trans('Install Memory Configuration') }}
                                                </a>
                                            </li>
                                            <li>
                                                <a href="{{ route('AutoDiscovery.viewDiskConfiguration') }}"
                                                    {{ Request::is('AutoDiscovery/viewDiskConfiguration') ? ' class="active"' : '' }}>
                                                    {{ trans('Hard Disk Configuration') }}
                                                </a>
                                            </li>
                                            <li>
    ...
    <footer class="main-footer hidden-print">
        ...
        <a target="_blank" href="https://caniasset.canaris.in/" rel="noopener">Cani-Asset</a> is asset management
        software, made with <i class="fas fa-heart" style="color: #a94442; font-size: 10px"
            aria-hidden="true"></i><span class="sr-only">love</span> by <a href="https://www.canaris.in/"
            rel="noopener">@canaris</a>.
    </footer>
