...
{{-- Page title --}}
@section('title')
    Software Install UnInstall Log
    @parent
@stop
                            ...
                            <table id="exampleTable" class="display nowrap" style="width:100%">
                                <thead>
                                    <tr>
                                        ...
                                        <th>Application Publisher</th>
                                        <th>Application Version</th>
                                        <th>Application Install Date</th>
                                    </tr>
                                </thead>
                                <tbody>
                                    @foreach ($data as $item)
                                        <tr>
                                            ...
                                            <td>{{ $item->application_publisher }}</td>
                                            <td>{{ $item->application_version }}</td>
                                            <td>{{ $item->application_install_date }}</td>
                                        </tr>
                                    @endforeach
                                </tbody>
                            </table>
