                    ...
                    <section class="content" id="main">
                        <div class="row">
                            <div class="col-lg-8 col-lg-offset-2 col-md-10 col-md-offset-1 col-sm-12 col-sm-offset-0">
                                <form  id="subnetscanform" action="{{ route('AutoDiscovery.addsubnetScan') }}" method="post" class="form-horizontal has-validation-callback">
                                    @csrf
                                    <div class="box box-default">
                                        <div class="box-body">
                                            <div class="text-left" style="text-align: left; font-size: 24px; color: #333; margin-bottom: 20px; margin-top: 10px;">Subnet Scan</div>
                                            ...
                                            <div class="box-footer text-right">
                                                <a href="{{ route('AutoDiscovery.subnetScan') }}" class="btn btn-link text-left">Cancel</a>
...
<script>
    ...
    $(document).ready(function() {
        $('#subnetscanform').submit(function(event) {
                    ...
                    success: function(response) {
                        ...
                        Swal.fire({
                            ...
                            if (result.isConfirmed) {
                                window.location.href = '/AutoDiscovery/subnetScan';
                            }
                        });
                    },
